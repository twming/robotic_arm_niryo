...
class StorageManager:
    ...
    def __init__(self):
        ...
        process_result = subprocess.call(['roslaunch-logs'])
        current_ros_logs_path = Path(str(process_result))
    ...
    def get_storage(value):
        try:
            process = subprocess.Popen(['df', '--output={value}', '/'], stdout=subprocess.PIPE)
